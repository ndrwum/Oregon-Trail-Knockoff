...
public abstract class PersonImpl extends Observable implements Person {
	...
	protected PersonImpl(String name, int hp_range_min, int hp_range_max,
		...
		if (name == null || hp_range_min < 0 || hp_range_max < 0
				|| skill_range_min < 0 || skill_range_max < 0
	...
	public static Person generatePerson() {
		String[] first_names = {"Alice", "Bob", "Chetan", "Wei", "Min-Soo",
				"Mary", "Dave", "Mike", "Lachina"};
		String[] last_names = {"Perry", "Jones", "Carmichael", "Shah", "Kum",
				"Lee", "Carter", "Au", "Wilson"};
	...
	public String toString() {
		return getName() + " (HP: " + getCurrentHP() + "/" + getMaxHP()
				+ ", Skill: " + getSkill() + ", " + getStatus().toString()
				+ ")";
	}
}