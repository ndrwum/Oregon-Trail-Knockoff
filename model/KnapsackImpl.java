...
public class KnapsackImpl extends Observable implements Knapsack {
	...
	public int getTotalWeight() {
		return (food_pouch.getTotalWeight() + powerup_pouch.getTotalWeight()
	...
	public Supplies[] getSupplies() {
		...
		Supplies[] supplies = new Supplies[food_pouch_items.length
				+ powerup_pouch_items.length + clothing_pouch_items.length];
		int i = 0;
	...
	public Food[] getEdibleSupplies() {
		...
		Food[] edible_supplies = new Food[food_pouch_items.length
				+ powerup_pouch_items.length];
		int i = 0;
		for (int j = 0; j < food_pouch_items.length; j++) {
