...
public class SquadImpl implements Squad {
	...
	public SquadImpl(Person[] players, double balance) {
		if (players == null | players.length < 1) {
			throw new IllegalArgumentException(
					"Must have at least 1 player on the sqaud.");
		}
	...
	@Override
	public void purchaseSupply(String supply_name, int count, Store store)
			throws ItemNotForSaleException, InsufficientFundsException {
