...
public class Adventure {
	...
	public Adventure(Difficulty mode, Squad squad) {
		...
		City[] all_cities = new City[]{chapel_hill, charlotte, atlanta, dc,
				new_york, chicago, austin, minneapolis, seattle, sf, palo_alto};

		set_distances(chapel_hill, all_cities, new int[]{0, 140, 380, 271, 500,
				784, 1300, 1194, 2849, 2813, 2787});
		set_distances(charlotte, all_cities, new int[]{140, 0, 200, 398, 625,
				756, 1164, 1166, 2795, 2708, 2682});
		set_distances(atlanta, all_cities, new int[]{380, 200, 0, 639, 864, 717,
				921, 1112, 2636, 2472, 2446});
		set_distances(dc, all_cities, new int[]{271, 298, 639, 0, 225, 699,
				1524, 1106, 2761, 2817, 2844});
		set_distances(new_york, all_cities, new int[]{500, 625, 864, 225, 0,
				790, 1742, 1197, 2852, 2569, 2562});
		set_distances(chicago, all_cities, new int[]{784, 756, 717, 699, 790, 0,
				1120, 404, 2064, 2131, 2158});
		set_distances(austin, all_cities, new int[]{1300, 1164, 921, 1524, 1742,
				1120, 0, 1173, 2127, 1759, 1733});
		set_distances(minneapolis, all_cities, new int[]{1194, 1166, 1112, 1106,
				1197, 404, 1173, 0, 1656, 1977, 2004});
		set_distances(seattle, all_cities, new int[]{2849, 2795, 2636, 2761,
				2852, 2064, 2127, 1656, 0, 808, 835});
		set_distances(sf, all_cities, new int[]{2813, 2708, 2472, 2817, 2569,
				2131, 1759, 1977, 808, 0, 33});
		set_distances(palo_alto, all_cities, new int[]{2787, 2682, 2446, 2844,
				2562, 2158, 1733, 2004, 835, 33, 0});
	...
	private static void set_distances(City city, City[] all_cities,
			int[] distances) {
